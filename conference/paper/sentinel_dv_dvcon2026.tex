...
over real simulation artifacts. Sentinel DV parses UVM logs from three commercial
simulators (VCS, Questa, Xcelium), extracts coverage metrics from vendor HTML
...
Five adapters parse vendor-specific formats: UVM log parser (3 simulators),
...
projects spanning three simulator vendors.}
\label{fig:val}
\end{figure}
...
Validated on 1,477 real CI runs across six projects and three simulator vendors,
