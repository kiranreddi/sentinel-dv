    ...
    \column{0.48\textwidth}
      \begin{block}{Any LLM, Any CI, Any Simulator}
        \begin{itemize}
          ...
          \item Pure-Python, MIT licensed, PyPI installable
        \end{itemize}
      \end{block}
      \vspace{0.4em}
