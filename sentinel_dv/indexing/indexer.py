...
class ArtifactIndexer:
    ...
    def __init__(self, artifact_roots: list[str], db_path: Path | str):
    ...
    def index_all(self) -> dict[str, int]:
        ...
        stats = {"artifacts": len(artifacts), "runs": 0, "tests": 0, "failures": 0}
        ...
        with IndexStore(self.db_path) as store:
            for path in artifacts:
                ...
                elif path.name in {"results.xml", "junit.xml"}:
