...
Runnable examples shipped with Sentinel DV (**v2.0.0+**):

| Path | Description | Documentation |
|------|-------------|---------------|
| [axi4_sentinel_demo.py](axi4_sentinel_demo.py) | **All 21 MCP tools** against AXI4 UVM (VCS + Questa + Xcelium) | [AXI4 demo](../demo/axi4_uvm/README.md) |
...
Install: `pip install "sentinel-dv>=2.0.0"`
