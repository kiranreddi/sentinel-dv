...
Runnable examples shipped with Sentinel DV (**v2.3.1+**, 28 MCP tools):

| Path | Description | Documentation |
|------|-------------|---------------|
| [axi4_sentinel_demo.py](axi4_sentinel_demo.py) | **All 28 MCP tools** against AXI4 UVM (VCS + Questa + Xcelium) | [AXI4 demo](../demo/axi4_uvm/README.md) |
...
| [demo/axi4_uvm/](../demo/axi4_uvm/) | AXI4-Lite slave RTL + UVM TB + 4-simulator artifacts | [AXI4 README](../demo/axi4_uvm/README.md) |
...
Install: `pip install "sentinel-dv>=2.3.1"`
