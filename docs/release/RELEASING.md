...
```bash
# After bumping pyproject.toml to 2.2.0 and updating docs pins:
./scripts/pre_release.sh v2.2.0
```
...
| `examples/README.md`, `docs/examples/*.md`, `mkdocs.yml` | install pins (`>=X.Y.Z`) |
